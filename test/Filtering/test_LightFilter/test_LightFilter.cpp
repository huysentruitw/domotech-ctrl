...
void LightFilter_Constructor_CreatesPins()
{
    // Arrange
    LightFilter filter;
...
void LightFilter_ToggleInput_ChangesControlOutput()
{
    // Arrange
    LightFilter filter;
    auto inputPins = filter.GetInputPins();
...
void LightFilter_FeedbackInput_ForwardsToFeedbackOutput()
{
    // Arrange
    LightFilter filter;
    auto inputPins = filter.GetInputPins();
...
int main()
{
    ...
    RUN_TEST(LightFilter_Constructor_CreatesPins);
    RUN_TEST(LightFilter_ToggleInput_ChangesControlOutput);
    RUN_TEST(LightFilter_FeedbackInput_ForwardsToFeedbackOutput);
